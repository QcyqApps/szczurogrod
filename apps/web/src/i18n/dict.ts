...
export const dict = {
  ...
  'town.banner.topWar.title': { pl: 'WOJNA NA SERWERZE', en: 'SERVER WAR' },
  'town.banner.topWar.vs': { pl: 'kontra', en: 'vs' },
  'town.banner.topWar.startsIn': { pl: 'start za {time}', en: 'starts in {time}' },
  'town.banner.topWar.resolving': { pl: 'TRWA STARCIE', en: 'CLASH IN PROGRESS' },
  'town.banner.myWar.title': { pl: 'TWOJA GILDIA W WOJNIE', en: 'YOUR GUILD AT WAR' },
  'town.banner.myWar.startsIn': { pl: 'start za {time}', en: 'starts in {time}' },
  'town.banner.myWar.resolving': { pl: 'TRWA — sprawdź wynik', en: 'IN PROGRESS — check result' },
  'town.banner.myRaid.title': { pl: 'AKTYWNY RAJD GILDII', en: 'GUILD RAID ACTIVE' },
  'town.banner.myRaid.hits': { pl: 'twoje uderzenia: {cur}/{max}', en: 'your hits: {cur}/{max}' },
  'warSpectator.title': { pl: 'WOJNA GILDII', en: 'GUILD WAR' },
  'warSpectator.loading': { pl: 'Ładuję starcie...', en: 'Loading clash...' },
  'warSpectator.notFound': { pl: 'Brak wojny — banner mógł wygasnąć.', en: 'No war found — banner may have expired.' },
  'warSpectator.vs': { pl: 'kontra', en: 'vs' },
  'warSpectator.startsIn': { pl: 'start za {time}', en: 'starts in {time}' },
  'warSpectator.resolving': { pl: 'TRWA STARCIE', en: 'CLASH IN PROGRESS' },
  'warSpectator.resolved': { pl: 'Wygrała „{winner}". Wynik {a}:{d}.', en: '„{winner}" won. Score {a}:{d}.' },
  'warSpectator.cancelled': { pl: 'Wojna odwołana.', en: 'War cancelled.' },
  'warSpectator.attacker': { pl: 'ATAKUJĄCY', en: 'ATTACKERS' },
  'warSpectator.defender': { pl: 'BRONIĄCY', en: 'DEFENDERS' },
  'warSpectator.empty': { pl: 'Nikt się nie zgłosił.', en: 'No one signed up.' },
  'warSpectator.notInvolved': { pl: 'To nie twoja wojna. Możesz tylko patrzeć.', en: 'Not your war. You can only watch.' },
  ...
  // ===== Server-side error messages (translated client-side) =====
  // Server zwraca polski string, `translateServerError()` mapuje go na EN.
  'error.work.blocksCombat': {
    pl: 'Pracujesz. Wróć do tablicy pracy żeby skończyć albo wyjść.',
    en: "You're working. Head back to the work board to finish or quit.",
  },
  ...
  'combat.log.spellBuff': { pl: '{name} skupia siły — zaklęcie wzmacnia!', en: '{name} gathers focus — spell empowers!' },
  ...
  'combat.btn.spell.warrior': { pl: 'KRZYK', en: 'SHOUT' },
  'combat.btn.spell.title.warrior': { pl: 'Krzyk Bojowy: +8 ATK na 2 tury, leczy 15 HP. Koszt −5 MP, cooldown 4.', en: 'War Shout: +8 ATK for 2 turns, heals 15 HP. Cost −5 MP, cooldown 4.' },
  'combat.btn.spell.rogue': { pl: 'SZTYLET', en: 'STAB' },
  'combat.btn.spell.title.rogue': { pl: 'Sztylet w Plecy: gwarantowany krytyk, ignoruje 30% pancerza. Koszt −8 MP, cooldown 4.', en: 'Backstab: guaranteed crit, ignores 30% of armor. Cost −8 MP, cooldown 4.' },
  'combat.btn.spell.mage': { pl: 'ISKRA', en: 'SPARK' },
  'combat.btn.spell.title.mage': { pl: 'Iskra: ignoruje 50% pancerza celu. Koszt −10 MP. Bez cooldownu.', en: 'Spark: ignores 50% of target armor. Cost −10 MP. No cooldown.' },
  'combat.btn.spell.cooldown': { pl: 'na chłodzeniu', en: 'cooling down' },
  'combat.buff.title': { pl: 'Aktywny buff bojowy. Tury: ile zostało.', en: 'Active combat buff. Turns: remaining.' },
...
`,
  ...
  'gemShop.bundles.previewHint': { pl: 'Tknij przedmiot, aby zobaczyć staty.', en: 'Tap an item to inspect stats.' },
  'gemShop.currency': { pl: 'zł', en: 'PLN' },
  'common.close': { pl: 'ZAMKNIJ', en: 'CLOSE' },
  'item.rarity.common': { pl: 'POSPOLITY', en: 'COMMON' },
  'item.rarity.rare': { pl: 'RZADKI', en: 'RARE' },
  'item.rarity.epic': { pl: 'EPICKI', en: 'EPIC' },
  'item.rarity.legendary': { pl: 'LEGENDARNY', en: 'LEGENDARY' },
  'item.slot.weapon': { pl: 'Broń', en: 'Weapon' },
  'item.slot.armor': { pl: 'Pancerz', en: 'Armor' },
  'item.slot.shield': { pl: 'Tarcza', en: 'Shield' },
  'item.slot.helmet': { pl: 'Hełm', en: 'Helmet' },
  'item.slot.trinket': { pl: 'Bibelot', en: 'Trinket' },
  'item.slot.potion': { pl: 'Mikstura', en: 'Potion' },
  'item.slot.any': { pl: 'Uniwersalny', en: 'Any slot' },
  'item.cls.warrior': { pl: 'Wojownik', en: 'Warrior' },
  'item.cls.mage': { pl: 'Mag', en: 'Mage' },
  'item.cls.rogue': { pl: 'Łotr', en: 'Rogue' },
  ...
  'gemShop.vip.name': { pl: 'SZCZUROGRÓD+ PAKIET 30 DNI', en: 'RATBURG+ 30-DAY BUNDLE' },
  'gemShop.vip.sub': { pl: 'Gemy + subskrypcja w jednym', en: 'Gems + subscription in one' },
  'gemShop.vip.price': { pl: '19,99 zł', en: '19.99 PLN' },
  'gemShop.vip.perk1': { pl: '3000 gemów na start', en: '3000 gems upfront' },
  'gemShop.vip.perk2': { pl: '+20% XP przez 30 dni', en: '+20% XP for 30 days' },
  'gemShop.vip.perk4': { pl: 'Stack do 90 dni subskrypcji', en: 'Stacks up to 90-day subscription' },
  'gemShop.disclaimer': {
  ...
  'guild.tab.browse': { pl: 'INNE', en: 'BROWSE' },
  'guild.browse.empty': { pl: 'Pusto. Nikt jeszcze się nie zorganizował.', en: 'Empty. Nobody else has organized yet.' },
  'guild.browse.row.meta': {
    pl: 'Lv {lvl} · {count}/{cap} · {glory} chwały',
    en: 'Lv {lvl} · {count}/{cap} · {glory} glory',
  },
